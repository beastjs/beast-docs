        ...
        <code suppressHydrationWarning>
          {lines
            ? lines.map((line, index) => (
                <span suppressHydrationWarning className='code-line' key={index}>
